...
Transfer Acceleration nutzt das [CloudFront-Netzwerk](../../docs/services/CloudFront.md), um Daten an den Randstandorten des CDN ([Content Delivery Network](https://de.wikipedia.org/wiki/Content_Delivery_Network) zu senden oder von dort zu empfangen, anstatt langsamere Uploads oder Downloads am Ursprungsort durchzuführen.
