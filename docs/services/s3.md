...
Amazon Simple Notification Service (Amazon [SNS](../../docs/services/SimpleNotificationService.md)): Ein Webdienst, der die Koordination und Verwaltung der Zustellung oder des Sendens von Nachrichten an abonnierende Endpunkte oder Clients ermöglicht.
Amazon Simple Queue Service (Amazon [SQS](../../docs/services/SimpleQueueService.md)): SQS bietet zuverlässige und skalierbare gehostete Warteschlangen zum Speichern von Nachrichten während ihrer Übertragung zwischen Computern.
