...
Amazon **s3** wurde im Jahr 2006 von Amazon Web Services (AWS) eingeführt. Es war einer der ersten Dienste, die von AWS angeboten wurden und revolutionierte die Art und Weise, wie Daten in der [Cloud](https://de.wikipedia.org/wiki/Cloud_Computing) gespeichert und abgerufen werden.
...
* Für rein programmatischen Zugriff: -> [IAM](../../docs/services/IAM.md) und Bucket-[Policies](https://awspolicygen.s3.amazonaws.com/policygen.html) verwenden, um ganze Buckets freizugeben.
...
* Für Zugriff über die Konsole und das Terminal: -> Cross-Account [IAM](../../docs/services/IAM.md)-Rollen verwenden.
...
Serverseitige Verschlüsselung mit kundeneigenen Schlüsseln / SSE - C: Du gibst Amazon deren eigenen Schlüssel, die Sie verwalten. In diesem Szenario gibst du die einfache Nutzung zugunsten einer höheren Kontrolle auf.
...
Wenn du den Inhalt eines Buckets in einen anderen replizierst, kannst du tatsächlich den Besitz des Inhalts ändern, wenn du dies wünschst. Du kannst auch die Speicherebene des neuen Buckets mit dem replizierten Inhalt ändern.
...
Dies wird erreicht, indem du eine separate URL für den Randstandort verwendest, anstatt den Bucket selbst zu verwenden. Die Daten werden dann über das AWS-Netzwerkrückgrat mit einer viel höheren Geschwindigkeit übertragen.
...
### S3 Managed Keys / SSE - S3 (Server-seitige Verschlüsselung S3): 
Amazon verwaltet automatisch die Verschlüsselungs- und Entschlüsselungsschlüssel für Sie. In diesem Szenario geben Sie etwas Kontrolle an Amazon ab, erhalten jedoch eine einfache Nutzung.

### AWS Key Management Service / SSE - KMS: 
Amazon und Sie verwalten gemeinsam die Verschlüsselungs- und Entschlüsselungsschlüssel.
