...
[S3 Versioning Dokumentation](https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html)
...
Sobald die Versionierung für einen Bucket aktiviert ist, kann sie nicht deaktiviert, sondern nur ausgesetzt
